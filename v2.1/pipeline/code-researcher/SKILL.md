...
description: "Read-only codebase exploration agent. Uses haiku for cheap, fast search. Returns structured summary <=2000 tokens. Invoked via Task tool by planner or coder for L/XL tasks."
model: haiku
