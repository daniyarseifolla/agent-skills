---
name: literal-pipeline-figma-coding-rules
description: "Figma extraction, CSS self-verify, UI quality check, icon rules, and UI implementation rules. Loaded by literal-pipeline-coder when design adapter is active. Never invoked directly by user."
disable-model-invocation: true
---

# Figma Coding Rules

Loaded by literal-pipeline-coder Phase 3 when design adapter is active. Contains all Figma extraction, verification, and UI implementation rules.
