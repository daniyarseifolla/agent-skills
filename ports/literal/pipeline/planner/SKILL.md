...
steps:
  ...
  step_8_handoff:
    action: "Form handoff per literal-core-orchestration planner_to_reviewer contract"
    payload:
...
code_researcher_dispatch:
  ...
  method: "Agent tool → literal-pipeline-code-researcher"
