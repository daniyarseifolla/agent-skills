---
name: literal-facade-figma-audit
...
node_map:
  ...
  rate_limiting:
    ...
    note: "Max 5 get_design_context calls per minute per literal-adapter-figma rate limits"
  ...
  agent_1_structure:
    ...
    prompt: |
      You are the Structure Mapper agent for a Figma audit (Step 1).
  ...
  agent_2_visual:
    ...
    budget: "max 60 tool calls"
    prompt: |
      You are the Visual Matcher agent for a Figma audit (Step 1).
  ...
  agent_3_code:
    ...
    budget: "max 60 tool calls"
    prompt: |
      You are the Code Scanner agent for a Figma audit (Step 1).
...
comparison:
  ...
  agent_1_visual:
    ...
    prompt: |
      You are the Visual Comparator for Figma audit Step 2.
  ...
  agent_2_property:
    ...
    prompt: |
      You are the Property & Structure Auditor for Figma audit Step 2.
  ...
  agent_3_ux:
    ...
    budget: "max 80 tool calls, 15 min"
    prompt: |
      You are the UX/Interaction Reviewer for Figma audit Step 2.
...
implementation:
  ...
  inline_fix:
    steps:
      ...
      - "Self-Verify: load literal-pipeline-figma-coding-rules Section 2 — compare every CSS property against Figma"
  ...
  subagent_dispatch:
    ...
    subagent_prompt_template: |
      ...
      3. Self-Verify: load Skill literal-pipeline-figma-coding-rules Section 2
