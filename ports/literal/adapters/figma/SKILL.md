...
preflight:
  ...
  on_unavailable: |
    ...
    - CSS extraction (literal-pipeline-figma-coding-rules)
...
errors:
  ...
  raster_instead_of_svg:
    ...
    fix: "See literal-pipeline-figma-coding-rules section 4 (Icon Extraction). Ask user to export SVG."
```
